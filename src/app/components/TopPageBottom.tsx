    ...
    <PageContainer>
      ...
      <MainContent>
        <Card>
          ...
          <CardText>
            独創性・変人度・常識感などから、一つの目安としての診断結果をご提供します
          </CardText>
        </Card>
        ...
        <Card>
          ...
          <CardText>
            文豪タイプに応じて最適の学習プランを提案し、学習管理のポイントに加算します
          </CardText>
        </Card>
      </MainContent>
      ...
      <FormSection>
        <Subtitle>
          診断に際し会員登録すると自分の学習記録を文豪種別として保存できます
        </Subtitle>
      ...
      <FooterSection>
        ...
        <FooterText>
          Webエンジニア | 20代中盤 |
          大学時代はGmailすら知らないIT音痴でプログラミングとは無縁の生活を送る
        </FooterText>
        <FooterText>
          → 独学でプログラミングを学ぶ → Web系受託開発企業にエンジニアとして就職
          →
        </FooterText>
        <FooterText>
          Web系自社サービス企業に転職 |
          実務未経験の頃からVimを愛好しており、仕事でもプライベートでも開発はVimとTmuxを使っているので、VSCodeに疎いのが最近の悩み。何だかんだでやっぱりRubyが好き。
        </FooterText>
